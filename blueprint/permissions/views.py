...
def create():
    ...
    return render_template('permissions/form.html', form=form, title='Create Permission')
...
def edit(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('permissions.index'))
    return render_template('permissions/form.html', form=form, title='Edit Permission')
